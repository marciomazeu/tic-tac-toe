...
function verificaVencedor(jogador, conteudo){
    ...
    if(quadrado[0].textContent == conteudo && quadrado[1].textContent == conteudo && quadrado[2].textContent == conteudo){
        chamaVitorioso(vitorioso);
    }
    //verifica se a linha do meio esta igual
    else if(quadrado[3].textContent == conteudo && quadrado[4].textContent == conteudo && quadrado[5].textContent == conteudo){
        chamaVitorioso(vitorioso);
    }
    //verifica se a linha inferior esta igual
    else if(quadrado[6].textContent == conteudo && quadrado[7].textContent == conteudo && quadrado[8].textContent == conteudo){
        chamaVitorioso(vitorioso);
    }
    
    //verifica se a coluna da esquerda esta igual
    else if(quadrado[0].textContent == conteudo && quadrado[3].textContent == conteudo && quadrado[6].textContent == conteudo){
        chamaVitorioso(vitorioso);
    }
    //verifica se a coluna do meio esta igual
    else if(quadrado[1].textContent == conteudo && quadrado[4].textContent == conteudo && quadrado[7].textContent == conteudo){
        chamaVitorioso(vitorioso);
    }
    //verifica se a coluna da direita esta igual
    else if(quadrado[2].textContent == conteudo && quadrado[5].textContent == conteudo && quadrado[8].textContent == conteudo){
        chamaVitorioso(vitorioso);
    }

    //verifica se a diagonal esta igual
    else if(quadrado[0].textContent == conteudo && quadrado[4].textContent == conteudo && quadrado[8].textContent == conteudo){
        chamaVitorioso(vitorioso);
    }
    //verifica se a diagonal esta igual
    else if(quadrado[2].textContent == conteudo && quadrado[4].textContent == conteudo && quadrado[6].textContent == conteudo){
        chamaVitorioso(vitorioso);
    }else{
        chamaEmpate();
    }
...
function handleClick(e){
    ...
    if(cell.textContent == 'X'){
        ...
        console.log("jogador 1: " + jogada1.sort(function (a, b) {
            return a - b;
        }));
        ...
        console.log("jogador 2: " + jogada2.sort(function (a, b) {
            return a - b;
        }));
